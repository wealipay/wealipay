  ...
  function d(n, r) {
    ...
    n.find(">ul:first >li").each(function(n) {
      ...
      if (r.data("link") != t) {
        ...
        if (i == "slide") {
          r.append(
            '<div class="tp-caption sft slidelink" data-x="0" data-y="0" data-linktoslide="' +
              o +
    ...
    revolution: function(r) {
      ...
      return this.each(function() {
        try {
          ...
          i.firefox13 =
            e.browser.mozilla &&
            (parseInt(e.browser.version, 0) == 13 ||
              parseInt(e.browser.version, 0) == 14 ||
              parseInt(e.browser.version, 0) == 15 ||
              parseInt(e.browser.version, 0) == 16);
